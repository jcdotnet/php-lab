...
const variations = [
    {
		name: 'facebook',
		isDefault: true, // this will override the regular block type (jc-blocks/share-button) in the inserter
		attributes: { service: 'facebook', text: 'Facebook', brandColor: '#4267B2', placeholder: 'Facebook' },
		title: 'Facebook',
		icon: FacebookIcon,
	},
	{
		name: 'twitter',
		attributes: { service: 'twitter', text: 'Twitter', brandColor: '#1DA1F2', placeholder: 'Twitter' },
		title: 'Twitter',
		icon: TwitterIcon,
	},
	{
		name: 'linkedin',
		attributes: { service: 'linkedin', text: 'LinkedIn', brandColor: '#0077B5', placeholder: 'LinkedIn' },
		title: 'LinkedIn',
		icon: LinkedInIcon,
	},
	{
		name: 'telegram',
		attributes: { service: 'telegram', text: 'Telegram', brandColor: '#0088cc', placeholder: 'Telegram' },
		title: 'Telegram',
		icon: TelegramIcon,
	},
	{
		name: 'whatsapp',
		attributes: { service: 'whatsapp', text: 'WhatsApp', brandColor: '#25D366', placeholder: 'WhatsApp' },
		title: 'WhatsApp',
		icon: WhatsAppIcon,
	},
]
...
/**
 * Add `isActive` function to all `sharing button` variations, if not defined.
